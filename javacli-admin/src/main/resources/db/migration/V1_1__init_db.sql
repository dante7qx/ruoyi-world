...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(nextval('sys_dept_dept_id_seq'),  0,   '0',          '精灵Spirit',   0, '系统管理员', '15888888888', 'admin@admin.com', '0', '0', '', 'fqyczadmin', CURRENT_TIMESTAMP, '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(nextval('sys_user_user_id_seq'),  (select dept_id from sys_dept where dept_name = '精灵Spirit'), 'fqyczadmin', '系统管理员', '00', 'fqyczadmin@admin.com', '15888888888', '1', '', '', 'xitongguanliyuan', 'XTGLY', '0', '0', '127.0.0.1', CURRENT_TIMESTAMP, 'fqyczadmin', CURRENT_TIMESTAMP, '', null, '管理员');
...
insert into sys_dict_type values(nextval('sys_dict_type_dict_id_seq'),  '栏目类型', 'sys_info_type',       '0', 'fqyczadmin', CURRENT_TIMESTAMP, '', null, '栏目类型列表');
