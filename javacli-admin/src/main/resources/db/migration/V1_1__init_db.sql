...
-- 初始化-角色信息表数据
-- ----------------------------
insert into sys_role values('1', '超级管理员',  'admin',  1, 1, 1, 1, '0', '0', 'superadmin', sysdate(), '', null, '超级管理员');
insert into sys_role values('2', '普通角色',    'common', 2, 2, 1, 1, '0', '0', 'superadmin', sysdate(), '', null, '普通角色');
insert into sys_role values('3', '信息录入员',  'info_record', 3, 2, 0, 0, '0', '0', 'superadmin', sysdate(), '', null, '信息录入员');
insert into sys_role values('4', '信息管理员',  'info_mgr', 4, 2, 0, 0, '0', '0', 'superadmin', sysdate(), '', null, '信息管理员');
...
-- 三级菜单
insert into sys_menu values('498',  '信息发布', '107', '1', 'infomgr',    'system/info/index',        '', 1, 0, 'C', '0', '0', 'system:info:list',        'message',       'superadmin', sysdate(), '', null, '信息发布菜单');
insert into sys_menu values('499',  '信息浏览', '107', '2', 'infoview',   'system/info/view',        '', 1, 0, 'C', '0', '0', 'system:info:list',         'eye-open',      'superadmin', sysdate(), '', null, '信息浏览菜单');
...
insert into sys_dict_type values(7,  '信息类型', 'sys_info_type',       '0', 'superadmin', sysdate(), '', null, '信息类型列表');
...
insert into sys_config values(1, '主框架页-默认皮肤样式名称',     'sys.index.skinName',            'skin-blue',     '1', 'superadmin', sysdate(), '', null, '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow' );
insert into sys_config values(2, '主框架页-侧边栏主题',           'sys.index.sideTheme',           'theme-dark',   '1', 'superadmin', sysdate(), '', null, '深色主题theme-dark，浅色主题theme-light' );
insert into sys_config values(3, '账号自助-验证码开关',           'sys.account.captchaEnabled',    'true',         '1', 'superadmin', sysdate(), '', null, '是否开启验证码功能（true开启，false关闭）');
insert into sys_config values(4, '账号自助-是否开启用户注册功能',  'sys.account.registerUser',      'false',         '1', 'superadmin', sysdate(), '', null, '是否开启注册用户功能（true开启，false关闭）');
insert into sys_config values(5, '短信发送标识码',               'sys.sms.sendModelID',           '123456',        '1', 'superadmin', sysdate(), '', null, '短信发送标识（向领导申请）');
insert into sys_config values(6, '用户管理-账号初始密码修改',      'sys.user.modifyInitPassword',   '0',        	    '1', 'superadmin', sysdate(), '', null, '初始密码修改（0: 不提示修改；1: 提示修改）' );
insert into sys_config values(7, '用户管理-账号密码更新周期',      'sys.user.modifyPasswordPeriod', '0',            '1', 'superadmin', sysdate(), '', null, '单位为天，账号密码每隔多少天进行修改提示。0表示不提示修改' );
insert into sys_config values(8, '用户管理-账号初始密码',         'sys.user.initPassword',         'rs@123!',      '1', 'superadmin', sysdate(), '', null, '初始化密码 rs@123!' );
insert into sys_config values(9, '视频监控服务器',         	   'sys.monitor.camera.server',     '127.0.0.1:3000',      '1', 'superadmin', sysdate(), '', null, '视频监控服务器地址(IP:PORT)' );
