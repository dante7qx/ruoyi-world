package com.spirit.common.utils.poi;
...
import com.spirit.common.utils.file.FileTypeUtils;
import com.spirit.common.utils.file.FileUtils;
import com.spirit.common.utils.file.ImageUtils;
import com.spirit.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        if (ColumnType.STRING == attr.cellType())
        {
            ...
            cell.setCellValue(StrUtil.isEmpty(cellValue) ? attr.defaultValue() : cellValue + attr.suffix());
        }
    ...
    {
        return isSubList() && CollUtil.isNotEmpty(getListCellValue(vo));
    }
