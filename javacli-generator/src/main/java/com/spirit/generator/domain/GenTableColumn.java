...
public class GenTableColumn extends BaseEntity {
	...
	public String getIsPk() {
		return StrUtil.emptyToDefault(isPk, "0");
	}
	...
	public String toString() {
		return "GenTableColumn [columnId=" + columnId + ", tableId=" + tableId + ", columnName=" + columnName
				...
				+ ", dictType=" + dictType + ", relTableName=" + relTableName + ", relColumnName=" + relColumnName
				+ ", relColumnComment=" + relColumnComment + ", relColumnType=" + relColumnType + ", relJavaType="
				+ relJavaType + ", relJavaField=" + relJavaField + ", sort=" + sort + "]";
	}
