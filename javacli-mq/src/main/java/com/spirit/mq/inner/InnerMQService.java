...
import com.spirit.mq.inner.exception.InnerMQException;
import com.spirit.mq.service.impl.SysInnerMqExceptionServiceImpl;
...
//					event.setConsumerClass(consumerClass);
	...
	private void init() {
		innerMQ = new Disruptor<>(
				InnerMQEvent::new, 
				RINGBUFFER_SIZE,
				new CustomizableThreadFactory("spirit-inner-mq-event-"), 
				ProducerType.MULTI, 
