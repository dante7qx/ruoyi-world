...
(function() {
  ...
  */
  ...
  var opt = {
    ...
    // icon: '<svg width="40" height="40" xmlns="http://www.w3.org/2000/svg"><text x="50%" y="50%" font-size="14" font-family="system-ui, sans-serif" text-anchor="middle" dominant-baseline="middle">排版</text></svg>'
