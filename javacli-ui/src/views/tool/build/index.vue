  ...
  <div class="container">
    ...
    <div class="center-board">
      <div class="action-bar">
        ...
        <el-button icon="el-icon-video-play" type="text" @click="run" v-show="false">
          运行
        </el-button>
        <el-button icon="el-icon-view" type="text" @click="showJson" v-show="false">
          查看json
        </el-button>
...
import render from '@/components/Process/render/render'
...
import { getDrawingList, saveDrawingList, getIdGlobal, saveIdGlobal, getFormConf } from '@/utils/generator/db'
...
<style lang='scss'>
@import '@/assets/styles/generator/home';
</style>
