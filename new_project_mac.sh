...
createNewProject() {
    ...
    sed -i '' "s/192.168.1.30:3306/<数据库url>/g" ./project-admin/src/main/resources/application-dameng.yml
    sed -i '' "s/risun_project/<数据库>/g" ./project-admin/src/main/resources/application-dameng.yml
    sed -i '' "s/risun/<数据库账号>/g" ./project-admin/src/main/resources/application-dameng.yml
    sed -i '' "s/risun@123!/<数据库密码>/g" ./project-admin/src/main/resources/application-dameng.yml
