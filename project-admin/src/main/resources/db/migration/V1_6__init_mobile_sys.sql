...
values('移动端管理', 0, 130, 'mobile', null, 1, 0, 'M', '0', '0', null, 'phone', 'fqyczadmin', sysdate(), '', null, '移动端管理目录');
...
-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('移动菜单', @parentId, '1', 'mbmenu', 'system/mobile/menu/index', 1, 0, 'C', '0', '0', 'system:mobile:menu:list', 'tree-table', 'fqyczadmin', sysdate(), '', null, '移动菜单');
...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('移动菜单查询', @parentId, '1',  '#', '', 1, 0, 'F', '0', '0', 'system:mobile:menu:query',        '#', 'fqyczadmin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('移动菜单新增', @parentId, '2',  '#', '', 1, 0, 'F', '0', '0', 'system:mobile:menu:add',          '#', 'fqyczadmin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('移动菜单修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'system:mobile:menu:edit',         '#', 'fqyczadmin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('移动菜单删除', @parentId, '4',  '#', '', 1, 0, 'F', '0', '0', 'system:mobile:menu:remove',       '#', 'fqyczadmin', sysdate(), '', null, '');
