...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询模板查询', @parentId, '1',  '#', '', 1, 0, 'F', '0', '0', 'system:caq:query',        '#', 'fqyczadmin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询模板新增', @parentId, '2',  '#', '', 1, 0, 'F', '0', '0', 'system:caq:add',          '#', 'fqyczadmin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询模板修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'system:caq:edit',         '#', 'fqyczadmin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询模板删除', @parentId, '4',  '#', '', 1, 0, 'F', '0', '0', 'system:caq:remove',       '#', 'fqyczadmin', sysdate(), '', null, '');
