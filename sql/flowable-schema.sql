...
create table sys_flow_group (
  group_id          bigint(20)      not null auto_increment    comment '流程组id',
...
create table sys_flow_group_user (
  ...
  group_id          bigint(20)      not null     			   comment '流程组id',
...
create table sys_flow_type (
  ...
  flow_group_id     bigint(20)      not null                   comment '流程组id',
  flow_def_key		varchar(64)     default ''                 comment '流程定义Key',
  order_num			int(10)		    default 1                  comment '排序',
...
create table sys_flow_trace (
  trace_id        	bigint(20)      not null auto_increment    comment 'Id',
  flow_num			bigint(20) 		not null 				   comment '流程序号',
  flow_date_num	    bigint(20) 		not null 				   comment '流程日期序号',
  ...
  commit_user_id 	bigint(20)      not null                   comment '提交人Id',
  ...
  flow_status   	tinyint(1) 		default 2                  comment '状态（1 待提交 2 审批中 3 完成）',
...
create table sys_flow_seq (
  id bigint(20) not null auto_increment comment 'Id',
  seq_num bigint(20) not null comment '自然序号',
  date_num bigint(20) not null comment '日期序号',
  primary key (id)
...
create table sys_flow_record (
  ...
  group_id 			bigint(20)      null                   	   comment '处理组Id',
  ...
  flow_result 		tinyint(1) 		null              	   	   comment '审批结果（1 通过 0 驳回）',
...
create table t_flow_demo (
  ...
  user_id bigint(20) comment '申请人Id',
