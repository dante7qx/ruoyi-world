...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '睿阳科技',   0, '系统管理员', '15888888888', 'admin@admin.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-岗位信息表数据
-- ----------------------------
insert into sys_post values(1, 'ceo',  '总负责人',    1, '0', 'admin', sysdate(), '', null, '');
